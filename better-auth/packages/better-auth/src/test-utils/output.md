/Users/josh/Documents/GitHub/better-auth/better-auth/packages/better-auth/src/test-utils/headers.ts
```typescript
/**
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/packages/better-auth/src/test-utils/test-instance.ts
```typescript
