/Users/josh/Documents/GitHub/better-auth/better-auth/packages/better-auth/src/cookies/check-cookies.ts
```typescript
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/packages/better-auth/src/cookies/cookie-utils.ts
```typescript
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/packages/better-auth/src/cookies/cookies.test.ts
```typescript
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/packages/better-auth/src/cookies/index.ts
```typescript
