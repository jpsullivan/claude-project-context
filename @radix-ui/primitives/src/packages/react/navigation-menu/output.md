/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/navigation-menu/CHANGELOG.md
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/navigation-menu/README.md
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/navigation-menu/eslint.config.mjs
```
// @ts-check
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/navigation-menu/package.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/navigation-menu/tsconfig.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/navigation-menu/src/index.ts
```typescript
'use client';
export {
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/navigation-menu/src/navigation-menu.tsx
```
