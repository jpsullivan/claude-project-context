/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/dropdown-menu/CHANGELOG.md
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/dropdown-menu/README.md
```
# `react-dropdown-menu`
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/dropdown-menu/eslint.config.mjs
```
// @ts-check
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/dropdown-menu/package.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/dropdown-menu/tsconfig.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/dropdown-menu/src/dropdown-menu.tsx
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/dropdown-menu/src/index.ts
```typescript
'use client';
export {
  createDropdownMenuScope,
