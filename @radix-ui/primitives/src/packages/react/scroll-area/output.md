/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/scroll-area/CHANGELOG.md
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/scroll-area/README.md
```
# `react-scroll-area`
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/scroll-area/eslint.config.mjs
```
// @ts-check
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/scroll-area/package.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/scroll-area/tsconfig.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/scroll-area/src/index.ts
```typescript
'use client';
export {
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/scroll-area/src/scroll-area.tsx
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/scroll-area/src/use-state-machine.ts
```typescript
import * as React from 'react';
