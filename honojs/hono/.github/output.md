/Users/josh/Documents/GitHub/honojs/hono/.github/FUNDING.yml
```yaml
github: ['yusukebe', 'usualoma']

```
/Users/josh/Documents/GitHub/honojs/hono/.github/pull_request_template.md
```
...
```
/Users/josh/Documents/GitHub/honojs/hono/.github/workflows/ci.yml
```yaml
name: ci
on:
  push:
...
```
/Users/josh/Documents/GitHub/honojs/hono/.github/workflows/no-response.yml
```yaml
...
```
/Users/josh/Documents/GitHub/honojs/hono/.github/workflows/release.yml
```yaml
name: release
...
```
/Users/josh/Documents/GitHub/honojs/hono/.github/ISSUE_TEMPLATE/1-bug-report.yml
```yaml
name: 🐛 Bug Report
...
```
/Users/josh/Documents/GitHub/honojs/hono/.github/ISSUE_TEMPLATE/2-feature-request.yml
```yaml
...
```
/Users/josh/Documents/GitHub/honojs/hono/.github/ISSUE_TEMPLATE/config.yml
```yaml
