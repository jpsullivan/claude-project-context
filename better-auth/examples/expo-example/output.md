/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/README.md
````
...
````
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/app.config.ts
```typescript
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/babel.config.js
```javascript
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/components.json
```json
{
	"aliases": {
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/index.ts
```typescript
import "expo-router/entry";

```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/metro.config.js
```javascript
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/nativewind-env.d.ts
```typescript
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/package.json
```json
{
  "name": "expo-example",
  "main": "index.ts",
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/tailwind.config.js
```javascript
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/tsconfig.json
```json
{
	"compilerOptions": {
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/expo-example/turbo.json
```json
{
