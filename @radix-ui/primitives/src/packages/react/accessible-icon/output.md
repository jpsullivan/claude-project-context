/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/accessible-icon/CHANGELOG.md
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/accessible-icon/README.md
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/accessible-icon/eslint.config.mjs
```
// @ts-check
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/accessible-icon/package.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/accessible-icon/tsconfig.json
```json
{
