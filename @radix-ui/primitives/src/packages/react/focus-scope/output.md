/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/focus-scope/CHANGELOG.md
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/focus-scope/README.md
```
# `react-focus-scope`
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/focus-scope/eslint.config.mjs
```
// @ts-check
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/focus-scope/package.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/focus-scope/tsconfig.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/focus-scope/src/focus-scope.test.tsx
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/focus-scope/src/focus-scope.tsx
```
import * as React from 'react';
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/focus-scope/src/index.ts
```typescript
'use client';
export {
  FocusScope,
