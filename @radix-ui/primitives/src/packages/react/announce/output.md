/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/announce/CHANGELOG.md
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/announce/README.md
```
# `react-announce`
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/announce/eslint.config.mjs
```
// @ts-check
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/announce/package.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/announce/tsconfig.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/announce/src/announce.tsx
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/announce/src/index.ts
```typescript
'use client';
export {
  Announce,
