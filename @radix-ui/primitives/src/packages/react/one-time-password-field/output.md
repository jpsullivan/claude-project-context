/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/one-time-password-field/CHANGELOG.md
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/one-time-password-field/README.md
````
...
````
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/one-time-password-field/eslint.config.mjs
```
// @ts-check
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/one-time-password-field/package.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/one-time-password-field/tsconfig.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/one-time-password-field/src/index.ts
```typescript
'use client';
export type {
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/one-time-password-field/src/one-time-password-field.test.tsx
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/one-time-password-field/src/one-time-password-field.tsx
```
