/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/README.md
````
![Banner](./header.webp)
...
````
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app.config.ts
```typescript
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/biome.json
```json
{
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/components.json
```json
{
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/package.json
```json
{
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/postcss.config.js
```javascript
export default {
	plugins: {
		tailwindcss: {},
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/tailwind.config.js
```javascript
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/tsconfig.json
```json
{
	"compilerOptions": {
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/api.ts
```typescript
import {
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/client.tsx
```
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/routeTree.gen.ts
```typescript
/* eslint-disable */
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/router.tsx
```
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/ssr.tsx
```
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/components/login-form.tsx
```
"use client";
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/components/register-form.tsx
```
"use client";
import { Link } from "@tanstack/react-router";
import { toast } from "sonner";
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/components/ui/avatar.tsx
```
"use client";
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/components/ui/button.tsx
```
"use client";
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/components/ui/card.tsx
```
"use client";
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/components/ui/dialog.tsx
```
"use client";
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/components/ui/input.tsx
```
"use client";
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/components/ui/label.tsx
```
"use client";
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/components/ui/navigation-menu.tsx
```
"use client";
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/components/ui/sonner.tsx
```
"use client";
...
```
/Users/josh/Documents/GitHub/better-auth/better-auth/examples/tanstack-example/app/login/page.tsx
```
import { LoginForm } from "~/components/login-form";
