/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/toggle-group/CHANGELOG.md
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/toggle-group/README.md
```
# `react-toggle-group`
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/toggle-group/eslint.config.mjs
```
// @ts-check
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/toggle-group/package.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/toggle-group/tsconfig.json
```json
{
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/toggle-group/src/index.ts
```typescript
'use client';
export {
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/toggle-group/src/toggle-group.test.tsx
```
...
```
/Users/josh/Documents/GitHub/radix-ui/primitives/packages/react/toggle-group/src/toggle-group.tsx
```
